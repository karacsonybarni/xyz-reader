...
import static androidx.palette.graphics.Palette.from;
...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void showTransparentStatusBar() {
        ...
        int backgroundColor = ContextCompat.getColor(activity, R.color.detailStatusBar);
            ...
            ImageLoaderHelper.getInstance(getActivity()).getImageLoader()
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                Palette p = from(bitmap).maximumColorCount(12).generate();
